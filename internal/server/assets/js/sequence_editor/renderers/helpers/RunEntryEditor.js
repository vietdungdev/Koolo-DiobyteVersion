...
export function createRunParameterEditor(entry, { markDirty, onChange, difficulty }) {
  ...
  grid.className = "run-parameter-grid";
  ...
  grid.appendChild(buildField("Min Level", minInput, "run-editor-field"));
  ...
  grid.appendChild(buildField("Max Level", maxInput, "run-editor-field"));

  const flags = document.createElement("div");
  flags.className = "checkbox-grid run-editor-flags";
