...
func StashFull() bool {
	...
	// Shared stash items are always available in memory with their page info;
	// reading them directly avoids opening the stash UI and prevents
	// corrupting CurrentStashTab state.
	ctx.RefreshGameData()
